# 🔒 Standard ACL (Numbered) Lab – IPv4

## 🎯 Objective

Configure and apply a Numbered Standard ACL on HYD router so that only host 192.168.201.10 can communicate with the 192.168.202.0/24 network, while other hosts are denied.

## 🖼️ Lab Topology

![Standard ACL With IPv4 Topology](Standard_Access_Control_List_IPv4_NUMBERED.png)
