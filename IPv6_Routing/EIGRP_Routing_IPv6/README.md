# 🔄 EIGRPv6 Routing Lab (CCNA)

## 🎯 Objective

Configure EIGRP for IPv6 between routers and verify dynamic routing, neighbor relationships, and communication across IPv6 networks.

## 🖼️ Lab Topology

![EIGRP With IPv6 Topology](EIGRP_Routing_IPv6.png)
...
| No routes learned     | Verify `ipv6 eigrp` on interfaces       |
...
- Fast convergence environments using EIGRPv6

## 🎯 Outcome
- Configured EIGRPv6 on routers
